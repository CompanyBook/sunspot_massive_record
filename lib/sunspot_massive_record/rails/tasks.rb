# 
# Taken from the sunspot rails gem
# https://github.com/outoftime/sunspot/blob/master/sunspot_rails/lib/sunspot/rails/tasks.rb
#
namespace :sunspot_massive_record do
  namespace :solr do
  ...
  task :reindex, :batch_size, :models, :needs => :environment do |t, args|
    ...
    unless args[:models]
      ...
      sunspot_models = all_models.select { |m| m < MassiveRecord::ORM::Base and m.searchable? }
    else
